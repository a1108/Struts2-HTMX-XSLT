...
<!--
    ...
    XSLT Concepts Covered:
      - <xsl:template match="/">     → Matches the root of the XML
      - <xsl:for-each select="...">  → Loops over XML elements
      - <xsl:value-of select="...">  → Outputs the text of an element
      - <xsl:if test="...">          → Conditional output
      - <xsl:sort select="...">      → Sorts elements
    ...
    <xsl:template match="/">
        ...
        <body>
            ...
            <main class="container">
                ...
                <section class="concept-card">
                    ...
                    <p>
                        ...
                        you see right now — entirely on the server, before sending
                ...
                <section class="list-section">
                    <div class="section-header">
                        ...
                        <!--
                            ...
                            (productList.xslt) — demonstrating HTMX + XSLT together.
                        -->
                        ...
                        <span id="xslt-spinner" class="htmx-indicator spinner">⟳</span>
                    </div>
            ...
            <footer class="app-footer">
                <p>🔄 This entire page was generated by XSLT — no JSP involved!</p>
            </footer>
